...
@ccclass
export default class ZnxgTouch extends cc.Component {
    ...
    onLoad() {
        ...
        this.node.on('touchstart', (event) => {
            ...
            GlobalEvent.emit(EventCfg.UPDATEINDEXLABEL, index);
        ...
        this.node.on('touchmove', (event) => {
            ...
            let localPos = this.node.convertToNodeSpaceAR(pos);
            if (GameCfg.GameType != pb.GameType.FenShi && StockData.ktype != pb.KType.Min) {
    ...
    protected onEnable(): void {
        GlobalEvent.emit(EventCfg.UPDATEINDEXLABEL, StockData.gpDataDay.length - 1);
    }
