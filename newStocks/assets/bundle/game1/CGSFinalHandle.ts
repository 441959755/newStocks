...
@ccclass
export default class CGSFinalHandle extends cc.Component {
    ...
    onShow() {
        ...
        let player = JSON.parse(JSON.stringify(GameCfg.RoomGameData.players[0]));
        ...
        this.codeTimeLabel.string = '比赛时段：' + TimeUtils.formatTime(gpData[GameData.huizhidatas - 1].day) + '--' + TimeUtils.formatTime(gpData[GameCfg.huizhidatas - 1].day);
...

        {
            ...
            userExp.string = 'EXP: ' + GameCfg.RoomGameData.players[1].gd.properties[pb.GamePropertyId.Exp] + '/' + GameData.gameConf.level_exp[GameCfg.RoomGameData.players[1].gd.properties[pb.GamePropertyId.Level]]
            ...
            if (ex >= GameData.gameConf.level_exp[GameCfg.RoomGameData.players[1].gd.properties[pb.GamePropertyId.Level]]) {
                ex -= GameData.gameConf.level_exp[GameCfg.RoomGameData.players[1].gd.properties[pb.GamePropertyId.Level]];
                userExp.string = 'EXP: ' + ex + '/' + GameData.gameConf.level_exp[
        ...
        let datas = {
            ...
            kFrom: parseInt(TimeUtils.fromatTime1(gpData[0].day)),
