...
@ccclass
export default class TiaoJianDan extends cc.Component {
    ...
    initCount() {
        ...
        this.tipsLabel2.string = '训练费用：' + Math.abs(GameData.gameConf.dxxl.cost[0].v) + '金币';
    ...
    TJDStartGameSet() {
        ...
        if (!GameData.vipStatus) {
            if (GameData.properties[pb.GamePropertyId.Gold] < GameData.gameConf.tjdxl.cost[0].v) {
