export default {
    ...
    CHANGEMNCGACCOUNT: 'CHANGEMNCGACCOUNT',


    SYNCQUOTEITEM: 'SYNCQUOTEITEM',

    GMAECOUNTERSCHANGE: 'GMAECOUNTERSCHANGE',
    ...
    OPENSETLAYER: 'OPENSETLAYER',

    OPENHISTORYLAYER: 'OPENHISTORYLAYER',

    OPENTJDGAME: 'OPENTJDGAME',
    ...
    UPDATEOTHERPLAYEROPT: 'UPDATEOTHERPLAYEROPT',
    ...
    CLICKFCBTN: 'CLICKFCBTN',

    MABOLLSWITCH: 'MABOLLSWITCH',

    SETMALABEL: 'SETMALABEL',

    OPENOTHERPLAYERHISLAYER: 'OPENOTHERPLAYERHISLAYER',

    GETCGSDATA: 'GETCGSDATA',

    OPENCGSLVRANK: 'OPENCGSLVRANK',
    ...
    ROOMOLAYERSTATUS: 'ROOMOLAYERSTATUS',
